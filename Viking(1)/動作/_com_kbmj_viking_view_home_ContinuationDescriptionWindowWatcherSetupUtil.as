package 
{
    ...
    public class _com_kbmj_viking_view_home_ContinuationDescriptionWindowWatcherSetupUtil extends Sprite implements IWatcherSetupUtil
    {

        public function _com_kbmj_viking_view_home_ContinuationDescriptionWindowWatcherSetupUtil()
        {
            return;
        }// end function
        ...
        {
            ContinuationDescriptionWindow.watcherSetupUtil = new _com_kbmj_viking_view_home_ContinuationDescriptionWindowWatcherSetupUtil;
            return;
        }// end function
