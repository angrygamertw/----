package 
{
    ...
    public class _com_kbmj_viking_view_GuildChatWindow_inlineComponent4WatcherSetupUtil extends Sprite implements IWatcherSetupUtil
    {

        public function _com_kbmj_viking_view_GuildChatWindow_inlineComponent4WatcherSetupUtil()
        {
            return;
        }// end function
        ...
        {
            GuildChatWindow_inlineComponent4.watcherSetupUtil = new _com_kbmj_viking_view_GuildChatWindow_inlineComponent4WatcherSetupUtil;
            return;
        }// end function
