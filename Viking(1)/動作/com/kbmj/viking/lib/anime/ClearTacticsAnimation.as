package com.kbmj.viking.lib.anime
{
    ...
    public class ClearTacticsAnimation extends EventDispatcher
    {
        private var loadQueue:Array;
        private var animations:Array;
        private var loadingCount:int;

        public function ClearTacticsAnimation()
        {
        ...
        {
            enqueueAnimation("ClearTactics", "/swf/animation/StageClear.swf");
            loadAnimations();
            return;
        }// end function
