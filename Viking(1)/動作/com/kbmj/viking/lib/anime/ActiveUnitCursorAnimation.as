package com.kbmj.viking.lib.anime
{
    ...
    public class ActiveUnitCursorAnimation extends EventDispatcher
    {
        private var loadQueue:Array;
        private var animations:Array;
        private var loadingCount:int;

        public function ActiveUnitCursorAnimation()
        {
        ...
        {
            enqueueAnimation("ActiveUnitCursor", "/swf/animation/active_unit_cursor.swf");
            loadAnimations();
            return;
        }// end function
        ...
        private function enqueueAnimation(param1:String, param2:String) : void
        {
