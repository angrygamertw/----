package com.kbmj.viking.lib.anime
{
    ...
    public class VictoryConditionAnimation extends EventDispatcher
    {
        private var loadQueue:Array;
        private var animations:Array;
        private var loadingCount:int;

        public function VictoryConditionAnimation()
        {
        ...
        {
            enqueueAnimation("VictoryCondition", "/swf/animation/VictoryCondition.swf");
            loadAnimations();
            return;
        }// end function
