package com.kbmj.viking.vo
{
    ...
    public class ItemsMasterVO extends Object implements IEventDispatcher
    {
        ...
        private var _crystalEffect:int;
        private var _name:String;
        public static const MASTER_TYPE:String = "ItemMaster";

        public function ItemsMasterVO()
        {
        ...
        {
            return Utils.i18n("generalMaterial");
        }// end function
        ...
        public function set equipment(param1:int) : void
        {
            var _loc_2:* = this.equipment;
            if (_loc_2 !== param1)
            {
                this._1076356494equipment = param1;
                this.dispatchEvent(PropertyChangeEvent.createUpdateEvent(this, "equipment", _loc_2, param1));
            }
            return;
        }// end function
        ...
        public function set crystalEffect(param1:int) : void
        {
            var _loc_2:* = this.crystalEffect;
            if (_loc_2 !== param1)
            {
                this._517892199crystalEffect = param1;
                this.dispatchEvent(PropertyChangeEvent.createUpdateEvent(this, "crystalEffect", _loc_2, param1));
            }
            return;
        }// end function
        ...
        private function set _517892199crystalEffect(param1:int) : void
        {
            _crystalEffect = param1;
            return;
        }// end function
        ...
        private function set _1076356494equipment(param1:int) : void
        {
            _equipment = param1;
            return;
        }// end function
        ...
        private function set _733902135available(param1:int) : void
        {
            _available = param1;
            return;
        }// end function
