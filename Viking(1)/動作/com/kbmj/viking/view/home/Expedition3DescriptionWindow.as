package com.kbmj.viking.view.home
{
    ...
    public class Expedition3DescriptionWindow extends PopupWindow implements IBindingClient
    {
        ...
        public var _Expedition3DescriptionWindow_Image1:Image;
        ...
        public static var EmbedSwfExpeditionDetail:Class = Expedition3DescriptionWindow_EmbedSwfExpeditionDetail;
        ...
        public function Expedition3DescriptionWindow()
        {
            _documentDescriptor_ = new UIComponentDescriptor({type:PopupWindow, propertiesFactory:function () : Object
            {
                return {childDescriptors:[new UIComponentDescriptor({type:Image, id:"_Expedition3DescriptionWindow_Image1"}), new UIComponentDescriptor({type:Label, id:"titleTextLabel", stylesFactory:function () : void
                {
                    this.color = 16777215;
            ...
            this.addEventListener("creationComplete", ___Expedition3DescriptionWindow_PopupWindow1_creationComplete);
            return;
        }// end function
        ...
        private function _Expedition3DescriptionWindow_bindingExprs() : void
        {
        ...
        public function ___Expedition3DescriptionWindow_PopupWindow1_creationComplete(event:FlexEvent) : void
        {
            comp();
            return;
        }// end function
        ...
        {
            var target:Expedition3DescriptionWindow;
            var watcherSetupUtilClass:Object;
            .mx_internal::setDocumentDescriptor(_documentDescriptor_);
            var bindings:* = _Expedition3DescriptionWindow_bindingsSetup();
            var watchers:Array;
            target;
            if (_watcherSetupUtil == null)
            {
                watcherSetupUtilClass = getDefinitionByName("_com_kbmj_viking_view_home_Expedition3DescriptionWindowWatcherSetupUtil");
        ...
        private function _Expedition3DescriptionWindow_bindingsSetup() : Array
        {
            var binding:Binding;
            var result:Array;
            ...
            {
                _Expedition3DescriptionWindow_Image1.source = param1;
                return;
            }// end function
            , "_Expedition3DescriptionWindow_Image1.source");
            result[0] = binding;
        ...
        {
            Expedition3DescriptionWindow._watcherSetupUtil = param1;
            return;
        }// end function
