package com.kbmj.viking.view.home
{
    ...
    public class ContinuationDescriptionWindow extends PopupWindow implements IBindingClient
    {
        ...
        public var _ContinuationDescriptionWindow_Image1:Image;
        ...
        var _watchers:Array;
        protected var _2135756891titleText:String;
        protected var _102865796level:String;
        ...
        public static var EmbedSwfExpeditionDetail:Class = ContinuationDescriptionWindow_EmbedSwfExpeditionDetail;
        ...
        public function ContinuationDescriptionWindow()
        {
            _documentDescriptor_ = new UIComponentDescriptor({type:PopupWindow, propertiesFactory:function () : Object
            {
                return {childDescriptors:[new UIComponentDescriptor({type:Image, id:"_ContinuationDescriptionWindow_Image1"}), new UIComponentDescriptor({type:Label, id:"titleTextLabel", stylesFactory:function () : void
                {
                    this.color = 16777215;
            ...
            this.addEventListener("creationComplete", ___ContinuationDescriptionWindow_PopupWindow1_creationComplete);
            return;
        }// end function

        protected function set level(param1:String) : void
        {
        ...
        protected function getBgSwf() : MovieClipLoaderAsset
        {
        ...
        protected function set titleText(param1:String) : void
        {
        ...
        protected function get level() : String
        {
            return this._102865796level;
        }// end function

        private function _ContinuationDescriptionWindow_bindingsSetup() : Array
        {
            var binding:Binding;
            var result:Array;
            ...
            {
                _ContinuationDescriptionWindow_Image1.source = param1;
                return;
            }// end function
            , "_ContinuationDescriptionWindow_Image1.source");
            result[0] = binding;
        ...
        {
            var target:ContinuationDescriptionWindow;
            var watcherSetupUtilClass:Object;
            .mx_internal::setDocumentDescriptor(_documentDescriptor_);
            var bindings:* = _ContinuationDescriptionWindow_bindingsSetup();
            var watchers:Array;
            target;
            if (_watcherSetupUtil == null)
            {
                watcherSetupUtilClass = getDefinitionByName("_com_kbmj_viking_view_home_ContinuationDescriptionWindowWatcherSetupUtil");
        ...
        private function _ContinuationDescriptionWindow_bindingExprs() : void
        {
        ...
        public function ___ContinuationDescriptionWindow_PopupWindow1_creationComplete(event:FlexEvent) : void
        {
            comp();
            return;
        }// end function
        ...
        {
            ContinuationDescriptionWindow._watcherSetupUtil = param1;
            return;
        }// end function
