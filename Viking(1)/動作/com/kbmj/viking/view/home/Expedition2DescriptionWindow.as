package com.kbmj.viking.view.home
{
    ...
    public class Expedition2DescriptionWindow extends PopupWindow implements IBindingClient
    {
        ...
        public var _Expedition2DescriptionWindow_Image1:Image;
        ...
        public static var EmbedSwfExpeditionDetail:Class = Expedition2DescriptionWindow_EmbedSwfExpeditionDetail;
        ...
        public function Expedition2DescriptionWindow()
        {
            _documentDescriptor_ = new UIComponentDescriptor({type:PopupWindow, propertiesFactory:function () : Object
            {
                return {childDescriptors:[new UIComponentDescriptor({type:Image, id:"_Expedition2DescriptionWindow_Image1"}), new UIComponentDescriptor({type:Label, id:"titleTextLabel", stylesFactory:function () : void
                {
                    this.color = 16777215;
            ...
            locationName = {BUTTON_GL:"屍人ヶ原", BUTTON_RK:"奈落谷", BUTTON_WS:"祟荒野", BUTTON_LG:"闇ヶ淵", BUTTON_MN:"腐火鉱山", BUTTON_FR:"咎森"};
            _bindings = [];
            _watchers = [];
            _bindingsByDestination = {};
            _bindingsBeginWithWord = {};
            mx_internal::_document = this;
            this.addEventListener("creationComplete", ___Expedition2DescriptionWindow_PopupWindow1_creationComplete);
            return;
        }// end function
        ...
        public function init(param1:String) : void
        {
            ...
            titleText = Utils.i18n("expedition2") + level + Utils.i18n("localize155");
        ...
        public function ___Expedition2DescriptionWindow_PopupWindow1_creationComplete(event:FlexEvent) : void
        {
            comp();
            return;
        }// end function
        ...
        {
            var target:Expedition2DescriptionWindow;
            var watcherSetupUtilClass:Object;
            .mx_internal::setDocumentDescriptor(_documentDescriptor_);
            var bindings:* = _Expedition2DescriptionWindow_bindingsSetup();
            var watchers:Array;
            target;
            if (_watcherSetupUtil == null)
            {
                watcherSetupUtilClass = getDefinitionByName("_com_kbmj_viking_view_home_Expedition2DescriptionWindowWatcherSetupUtil");
        ...
        private function _Expedition2DescriptionWindow_bindingsSetup() : Array
        {
            var binding:Binding;
            var result:Array;
            ...
            {
                _Expedition2DescriptionWindow_Image1.source = param1;
                return;
            }// end function
            , "_Expedition2DescriptionWindow_Image1.source");
            result[0] = binding;
        ...
        private function _Expedition2DescriptionWindow_bindingExprs() : void
        {
        ...
        {
            Expedition2DescriptionWindow._watcherSetupUtil = param1;
            return;
        }// end function
