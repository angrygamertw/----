package com.kbmj.viking.view.home
{
    ...
    public class ConfirmRecoveryWindow extends PopupWindow implements IBindingClient
    {
        ...
        public var _ConfirmRecoveryWindow_Image1:Image;
        public var _ConfirmRecoveryWindow_Image3:Image;
        public var _ConfirmRecoveryWindow_Image4:Image;
        var _bindingsBeginWithWord:Object;
        public var _ConfirmRecoveryWindow_Label1:Label;
        ...
        public function ConfirmRecoveryWindow()
        {
            _documentDescriptor_ = new UIComponentDescriptor({type:PopupWindow, propertiesFactory:function () : Object
            {
                return {childDescriptors:[new UIComponentDescriptor({type:Image, id:"_ConfirmRecoveryWindow_Image1"}), new UIComponentDescriptor({type:VBox, propertiesFactory:function () : Object
                {
                    ...
                    , propertiesFactory:function () : Object
                    {
                        ...
                        , propertiesFactory:function () : Object
                        {
                            ...
                            }), new UIComponentDescriptor({type:Label, id:"_ConfirmRecoveryWindow_Label1", stylesFactory:function () : void
                            {
                                this.fontSize = 11;
                                return;
                            }// end function
                ...
                }), new UIComponentDescriptor({type:Image, id:"_ConfirmRecoveryWindow_Image3", events:{click:"___ConfirmRecoveryWindow_Image3_click"}, propertiesFactory:function () : Object
                {
                    return {x:265, y:307};
                }// end function
                }), new UIComponentDescriptor({type:Image, id:"_ConfirmRecoveryWindow_Image4", events:{click:"___ConfirmRecoveryWindow_Image4_click"}, propertiesFactory:function () : Object
                {
                    return {x:395, y:307};
                }// end function
                })]};
            ...
            _embed_mxml__images_icon_power_png_227571469 = ConfirmRecoveryWindow__embed_mxml__images_icon_power_png_227571469;
            _bindings = [];
            _watchers = [];
            _bindingsByDestination = {};
            _bindingsBeginWithWord = {};
            mx_internal::_document = this;
            this.addEventListener("creationComplete", ___ConfirmRecoveryWindow_PopupWindow1_creationComplete);
            return;
        }// end function
        ...
        {
            var target:ConfirmRecoveryWindow;
            var watcherSetupUtilClass:Object;
            .mx_internal::setDocumentDescriptor(_documentDescriptor_);
            var bindings:* = _ConfirmRecoveryWindow_bindingsSetup();
            var watchers:Array;
            target;
            if (_watcherSetupUtil == null)
            {
                watcherSetupUtilClass = getDefinitionByName("_com_kbmj_viking_view_home_ConfirmRecoveryWindowWatcherSetupUtil");
        ...
        public function ___ConfirmRecoveryWindow_PopupWindow1_creationComplete(event:FlexEvent) : void
        {
            init();
            return;
        }// end function

        private function _ConfirmRecoveryWindow_bindingExprs() : void
        {
            var _loc_1:* = undefined;
            _loc_1 = _swf_bg;
            _loc_1 = Utils.i18n("localize120") + "HP" + Utils.i18n("localize121");
        ...
        private function _ConfirmRecoveryWindow_bindingsSetup() : Array
        {
            var binding:Binding;
            var result:Array;
            ...
            {
                _ConfirmRecoveryWindow_Image1.source = param1;
                return;
            }// end function
            , "_ConfirmRecoveryWindow_Image1.source");
            result[0] = binding;
            binding = new Binding(this, function () : String
            {
                var _loc_1:* = Utils.i18n("localize120") + "HP" + Utils.i18n("localize121");
                var _loc_2:* = _loc_1 == undefined ? (null) : (String(_loc_1));
                return _loc_2;
            }// end function
            , function (param1:String) : void
            {
                _ConfirmRecoveryWindow_Label1.text = param1;
                return;
            }// end function
            , "_ConfirmRecoveryWindow_Label1.text");
            result[1] = binding;
            binding = new Binding(this, function () : Object
            {
            ...
            , function (param1:Object) : void
            {
                _ConfirmRecoveryWindow_Image3.source = param1;
                return;
            }// end function
            , "_ConfirmRecoveryWindow_Image3.source");
            result[2] = binding;
            binding = new Binding(this, function () : Object
            {
            ...
            , function (param1:Object) : void
            {
                _ConfirmRecoveryWindow_Image4.source = param1;
                return;
            }// end function
            , "_ConfirmRecoveryWindow_Image4.source");
            result[3] = binding;
            return result;
        }// end function
        ...
        public function ___ConfirmRecoveryWindow_Image3_click(event:MouseEvent) : void
        {
            onConfirm();
            return;
        }// end function

        public function ___ConfirmRecoveryWindow_Image4_click(event:MouseEvent) : void
        {
            onClose();
            return;
        }// end function
        ...
        {
            ConfirmRecoveryWindow._watcherSetupUtil = param1;
            return;
        }// end function
