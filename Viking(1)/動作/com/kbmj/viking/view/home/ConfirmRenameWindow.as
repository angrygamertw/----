package com.kbmj.viking.view.home
{
    ...
    public class ConfirmRenameWindow extends PopupWindow implements IBindingClient
    {
        private var _embed_mxml__images_icon_power_png_227571469:Class;
        public var _ConfirmRenameWindow_Image1:Image;
        public var _ConfirmRenameWindow_Image3:Image;
        public var _ConfirmRenameWindow_Image4:Image;
        var _bindingsByDestination:Object;
        public var _ConfirmRenameWindow_Label1:Label;
        ...
        public function ConfirmRenameWindow()
        {
            _documentDescriptor_ = new UIComponentDescriptor({type:PopupWindow, propertiesFactory:function () : Object
            {
                return {childDescriptors:[new UIComponentDescriptor({type:Image, id:"_ConfirmRenameWindow_Image1"}), new UIComponentDescriptor({type:VBox, propertiesFactory:function () : Object
                {
                    ...
                    , propertiesFactory:function () : Object
                    {
                        ...
                        , propertiesFactory:function () : Object
                        {
                            ...
                            }), new UIComponentDescriptor({type:Label, id:"_ConfirmRenameWindow_Label1", stylesFactory:function () : void
                            {
                                this.fontSize = 11;
                                return;
                            }// end function
                ...
                }), new UIComponentDescriptor({type:Image, id:"_ConfirmRenameWindow_Image3", events:{click:"___ConfirmRenameWindow_Image3_click"}, propertiesFactory:function () : Object
                {
                    return {x:265, y:307};
                }// end function
                }), new UIComponentDescriptor({type:Image, id:"_ConfirmRenameWindow_Image4", events:{click:"___ConfirmRenameWindow_Image4_click"}, propertiesFactory:function () : Object
                {
                    return {x:395, y:307};
                }// end function
                })]};
            ...
            _embed_mxml__images_icon_power_png_227571469 = ConfirmRenameWindow__embed_mxml__images_icon_power_png_227571469;
            _bindings = [];
            _watchers = [];
            _bindingsByDestination = {};
            _bindingsBeginWithWord = {};
            mx_internal::_document = this;
            this.addEventListener("creationComplete", ___ConfirmRenameWindow_PopupWindow1_creationComplete);
            return;
        }// end function
        ...
        public function ___ConfirmRenameWindow_PopupWindow1_creationComplete(event:FlexEvent) : void
        {
            init();
            return;
        }// end function

        private function _ConfirmRenameWindow_bindingsSetup() : Array
        {
            var binding:Binding;
            var result:Array;
            ...
            {
                _ConfirmRenameWindow_Image1.source = param1;
                return;
            }// end function
            , "_ConfirmRenameWindow_Image1.source");
            result[0] = binding;
            binding = new Binding(this, function () : String
            {
                var _loc_1:* = Utils.i18n("localize123");
                var _loc_2:* = _loc_1 == undefined ? (null) : (String(_loc_1));
                return _loc_2;
            }// end function
            , function (param1:String) : void
            {
                _ConfirmRenameWindow_Label1.text = param1;
                return;
            }// end function
            , "_ConfirmRenameWindow_Label1.text");
            result[1] = binding;
            binding = new Binding(this, function () : Object
            {
            ...
            , function (param1:Object) : void
            {
                _ConfirmRenameWindow_Image3.source = param1;
                return;
            }// end function
            , "_ConfirmRenameWindow_Image3.source");
            result[2] = binding;
            binding = new Binding(this, function () : Object
            {
            ...
            , function (param1:Object) : void
            {
                _ConfirmRenameWindow_Image4.source = param1;
                return;
            }// end function
            , "_ConfirmRenameWindow_Image4.source");
            result[3] = binding;
            return result;
        }// end function
        ...
        {
            var target:ConfirmRenameWindow;
            var watcherSetupUtilClass:Object;
            .mx_internal::setDocumentDescriptor(_documentDescriptor_);
            var bindings:* = _ConfirmRenameWindow_bindingsSetup();
            var watchers:Array;
            target;
            if (_watcherSetupUtil == null)
            {
                watcherSetupUtilClass = getDefinitionByName("_com_kbmj_viking_view_home_ConfirmRenameWindowWatcherSetupUtil");
        ...
        private function _ConfirmRenameWindow_bindingExprs() : void
        {
            var _loc_1:* = undefined;
            _loc_1 = _swf_bg;
            _loc_1 = Utils.i18n("localize123");
            _loc_1 = _swf_ok_button;
            _loc_1 = _swf_cancel_button;
            return;
        }// end function

        public function ___ConfirmRenameWindow_Image3_click(event:MouseEvent) : void
        {
            onConfirm();
            return;
        }// end function
        ...
        public function ___ConfirmRenameWindow_Image4_click(event:MouseEvent) : void
        {
            onClose();
            return;
        }// end function
        ...
        {
            ConfirmRenameWindow._watcherSetupUtil = param1;
            return;
        }// end function
