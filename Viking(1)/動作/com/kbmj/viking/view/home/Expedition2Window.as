package com.kbmj.viking.view.home
{
    ...
    public class Expedition2Window extends PopupWindow implements IBindingClient
    {
        ...
        public var _Expedition2Window_Image1:Image;
        ...
        public static var EmbedSwfExpedition:Class = Expedition2Window_EmbedSwfExpedition;
        ...
        public static var EmbedSwfLantern:Class = Expedition2Window_EmbedSwfLantern;

        public function Expedition2Window()
        {
            _documentDescriptor_ = new UIComponentDescriptor({type:PopupWindow, propertiesFactory:function () : Object
            {
                return {width:760, height:560, childDescriptors:[new UIComponentDescriptor({type:Image, id:"_Expedition2Window_Image1"}), new UIComponentDescriptor({type:Image, id:"products", propertiesFactory:function () : Object
                {
            ...
            description2Window = new Expedition2DescriptionWindow();
            _embed_mxml__swf_window_info_home_swf_1388347787 = Expedition2Window__embed_mxml__swf_window_info_home_swf_1388347787;
            _embed_mxml__swf_window_info_products_swf_1304559433 = Expedition2Window__embed_mxml__swf_window_info_products_swf_1304559433;
            _bindings = [];
            _watchers = [];
            ...
            this.addEventListener("creationComplete", ___Expedition2Window_PopupWindow1_creationComplete);
            return;
        }// end function
        ...
        private function _Expedition2Window_bindingsSetup() : Array
        {
            var binding:Binding;
            var result:Array;
            ...
            {
                _Expedition2Window_Image1.source = param1;
                return;
            }// end function
            , "_Expedition2Window_Image1.source");
            result[0] = binding;
            binding = new Binding(this, function () : Object
            {
        ...
        {
            description2Window.evilPoints = param1;
            return;
        }// end function
        ...
        public function ___Expedition2Window_PopupWindow1_creationComplete(event:FlexEvent) : void
        {
            init();
            return;
        }// end function
        ...
        {
            var target:Expedition2Window;
            var watcherSetupUtilClass:Object;
            .mx_internal::setDocumentDescriptor(_documentDescriptor_);
            var bindings:* = _Expedition2Window_bindingsSetup();
            var watchers:Array;
            target;
            if (_watcherSetupUtil == null)
            {
                watcherSetupUtilClass = getDefinitionByName("_com_kbmj_viking_view_home_Expedition2WindowWatcherSetupUtil");
        ...
        private function _Expedition2Window_bindingExprs() : void
        {
