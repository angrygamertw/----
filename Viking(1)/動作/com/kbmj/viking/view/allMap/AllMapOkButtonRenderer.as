package com.kbmj.viking.view.allMap
{
    ...
    public class AllMapOkButtonRenderer extends Box
    {
        ...
        public function AllMapOkButtonRenderer()
        {
            ...
            _embed_mxml__swf_home_buttons_button_list_decide_swf_1291455405 = AllMapOkButtonRenderer__embed_mxml__swf_home_buttons_button_list_decide_swf_1291455405;
        ...
        {
            parentDocument.okButtonClicked(data.unit);
            return;
        }// end function
