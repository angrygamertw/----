package com.kbmj.viking.controller.selectUnit
{
    ...
    public class StartSelectUnitForAllMapCommand extends SimpleCommand
    {
        public static const START_SELECT_UNIT:String = NAME + "/notes/StartSelectUnit";
        public static const NAME:String = "StartSelectUnitForAllMapCommand";
        public static const NO_UNITS_FOR_BATTLE:String = NAME + "/notes/noUnitsForBattle";

        public function StartSelectUnitForAllMapCommand()
        {
            return;
        }// end function
        ...
        override public function execute(param1:INotification) : void
        {
            ...
            _loc_2.units = _loc_4;
            _loc_2.selectUnitFor = SelectUnitProxy.FOR_ALL_MAP;
            _loc_3.suspendTimer();
