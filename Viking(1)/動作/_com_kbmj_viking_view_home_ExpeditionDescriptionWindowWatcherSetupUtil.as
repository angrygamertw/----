package 
{
    ...
    public class _com_kbmj_viking_view_home_ExpeditionDescriptionWindowWatcherSetupUtil extends Sprite implements IWatcherSetupUtil
    {

        public function _com_kbmj_viking_view_home_ExpeditionDescriptionWindowWatcherSetupUtil()
        {
            return;
        }// end function
        ...
        {
            ExpeditionDescriptionWindow.watcherSetupUtil = new _com_kbmj_viking_view_home_ExpeditionDescriptionWindowWatcherSetupUtil;
            return;
        }// end function
