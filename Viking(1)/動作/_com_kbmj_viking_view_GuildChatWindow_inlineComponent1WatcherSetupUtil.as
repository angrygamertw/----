package 
{
    ...
    public class _com_kbmj_viking_view_GuildChatWindow_inlineComponent1WatcherSetupUtil extends Sprite implements IWatcherSetupUtil
    {

        public function _com_kbmj_viking_view_GuildChatWindow_inlineComponent1WatcherSetupUtil()
        {
            return;
        }// end function
        ...
        {
            GuildChatWindow_inlineComponent1.watcherSetupUtil = new _com_kbmj_viking_view_GuildChatWindow_inlineComponent1WatcherSetupUtil;
            return;
        }// end function
