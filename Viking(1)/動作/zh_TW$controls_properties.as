...
{
    import mx.resources.*;
    import zh_TW$controls_properties.*;

    public class zh_TW$controls_properties extends ResourceBundle
    {

        public function zh_TW$controls_properties()
        {
            super("zh_TW", "controls");
            return;
        }// end function
