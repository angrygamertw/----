    ...
    public class WipeUpInstance extends MaskEffectInstance
    {
        ...
        override protected function initMaskEffect() : void
        {
            ...
            if (showTarget)
            {
                ...
                yFrom = _loc_1 + targetVisualBounds.y;
                xTo = targetVisualBounds.x;
                yTo = effectMask.height <= _loc_1 ? (targetVisualBounds.y) : (_loc_1 - effectMask.height + targetVisualBounds.y);
            }
            else
            {
                xFrom = targetVisualBounds.x;
                yFrom = effectMask.height <= _loc_1 ? (_loc_1 - effectMask.height + targetVisualBounds.y) : (targetVisualBounds.y);
                xTo = targetVisualBounds.x;
