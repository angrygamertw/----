package 
{
    ...
    public class _com_kbmj_viking_view_city_SilverDealWatcherSetupUtil extends Sprite implements IWatcherSetupUtil
    {

        public function _com_kbmj_viking_view_city_SilverDealWatcherSetupUtil()
        {
            return;
        }// end function
        ...
        public function setup(param1:Object, param2:Function, param3:Array, param4:Array) : void
        {
            ...
            param4[6] = new PropertyWatcher("_silverAmount", {propertyChange:true}, [param3[5], param3[7]], param2);
            param4[2] = new PropertyWatcher("_silverRate", {propertyChange:true}, [param3[1]], param2);
        ...
        {
            SilverDeal.watcherSetupUtil = new _com_kbmj_viking_view_city_SilverDealWatcherSetupUtil;
            return;
        }// end function
