package 
{
    ...
    public class _com_kbmj_viking_view_home_Expedition3DescriptionWindowWatcherSetupUtil extends Sprite implements IWatcherSetupUtil
    {

        public function _com_kbmj_viking_view_home_Expedition3DescriptionWindowWatcherSetupUtil()
        {
            return;
        }// end function
        ...
        {
            Expedition3DescriptionWindow.watcherSetupUtil = new _com_kbmj_viking_view_home_Expedition3DescriptionWindowWatcherSetupUtil;
            return;
        }// end function
