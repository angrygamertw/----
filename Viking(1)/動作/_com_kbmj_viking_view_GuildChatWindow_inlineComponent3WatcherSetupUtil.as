package 
{
    ...
    public class _com_kbmj_viking_view_GuildChatWindow_inlineComponent3WatcherSetupUtil extends Sprite implements IWatcherSetupUtil
    {

        public function _com_kbmj_viking_view_GuildChatWindow_inlineComponent3WatcherSetupUtil()
        {
            return;
        }// end function
        ...
        {
            GuildChatWindow_inlineComponent3.watcherSetupUtil = new _com_kbmj_viking_view_GuildChatWindow_inlineComponent3WatcherSetupUtil;
            return;
        }// end function
